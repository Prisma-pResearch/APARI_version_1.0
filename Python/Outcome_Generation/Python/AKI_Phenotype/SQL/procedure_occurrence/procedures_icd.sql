...
FROM
	...
	INNER JOIN DaTa_ScHeMa.PROCEDURE_OCCURRENCE p1 on p1.procedure_occurrence_id = c.subject_id
	INNER JOIN DaTa_ScHeMa.PROCEDURE_OCCURRENCE po on po.person_id = p1.person_id
...
WHERE
	...
	c.subset_id = YYYY
	AND
	po.procedure_date <= DATEADD(MONTH, 2, c.cohort_end_date)