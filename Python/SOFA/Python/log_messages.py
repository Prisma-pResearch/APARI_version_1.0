...
def _start_logging_to_file(directory: str, file_name: str = None):
    """
    Configure log file.
...
def _create_log_handler(log_name: str, directory: str = None):
...
def log_print_message(message: str,
                      log_name: str = None,
                      log_dir: str = None,
                      display: bool = False,
                      debug: bool = False,
    ...
    if isinstance(log_name, str):
        logger = _create_log_handler(log_name=log_name, directory=log_dir)
